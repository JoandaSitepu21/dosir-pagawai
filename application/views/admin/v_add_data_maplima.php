...
<head>
 ...
 <title>E-Dosir Kejati Papua | Tambah Data Map Lima</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Map Lima
        <small>Tambah Data Map Lima</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url().'admin/dashboard'?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url().'admin/map_lima'?>">Map Lima</a></li>
        <li class="active">Tambah Data Map Lima</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/map_lima/simpan_maplima'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
