...
<head>
 ...
 <title>E-Dosir Kejati Papua | Tambah Data Map Satu</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Map Satu
        <small>Tambah Data Map Satu</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url().'admin/dashboard'?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url().'admin/map_satu'?>">Map Satu</a></li>
        <li class="active">Tambah Data Map Satu</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tambah Data Map Satu</h3>
              <a href="<?php echo base_url().'admin/kepegawaian'?>" class="btn btn-warning btn-flat btn-sm pull-right">Kembali</a>
            </div>
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/map_satu/simpan_mapsatu'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
