...
<head>
 ...
 <title>E-Dosir Kejati Papua | Tambah Data Map Tiga</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Map Tiga
        <small>Tambah Data Map Tiga</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url().'admin/dashboard'?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url().'admin/map_tiga'?>">Map Tiga</a></li>
        <li class="active">Tambah Data Map Tiga</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/map_tiga/simpan_maptiga'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
