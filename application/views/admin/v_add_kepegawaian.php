...
<head>
 ...
 <title>E-Dosir Kejati Papua | Tambah Data Kepegawaian</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/kepegawaian/simpan_kepegawaian'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>Nama Lengkap</label>
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                    <input type="text" name="xnama" class="form-control" placeholder="Nama Lengkap">
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <label>Pangkat</label>
                   <div class="input-group">
                    ...
                    <input type="text" name="xpangkat" class="form-control" placeholder="Jabatan">
                  </div>
                </div>
                  </div>
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>NIP</label>
                       <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                        <input type="text" name="xnip" class="form-control" placeholder="Nomor Induk Pegawai">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>NRP</label>
                       <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                        <input type="text" name="xnrp" class="form-control" placeholder="NRP">
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                      <label>Tempat Lahir</label>
                       <div class="input-group">
                        ...
                        <input type="text" name="xtematlahir" class="form-control" placeholder="Tempat Lahir">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Tanggal Lahir</label>
                       <div class="input-group">
                        ...
                        <input type="text" name="xtanggallahir" class="form-control" placeholder="Tanggal Lahir">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Alamat</label>
                       <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                        <textarea name="xalamat" class="form-control" name="xalamat"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                      <label>Nomor Telpon</label>
                       <div class="input-group">
                        ...
                        <input type="text" name="xnotel" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                      ...
                      <label>Alamat Email</label>
                       <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-mail"></i></span>
                         <input type="text" name="xemail" class="form-control">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <label>Unit Kerja</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-balance-scale"></i></span>
                         <input type="text" name="xunitkerja" class="form-control">
                      </div>
                </div>
                <div class="form-group">
                  <label>Foto</label>
