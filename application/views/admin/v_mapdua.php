...
<head>
 ...
 <title>E-Dosir Kejati Papua | Map Dua</title>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Nip</th>
                  <th>Jabatan</th>
                  <th style="width:150px">Data Map Dua</th>
                </tr>
                </thead>
                <tbody>
                <?php     $no=0;
               ...
               <tr>
                  <td><?php echo $no;?></td>
                   ...
                   <td class="center">
                    ...
                    <a href="<?php echo base_url().'admin/map_dua/viewdatamap_dua/'.$kepegawaian_id;?>" class="btn btn-primary btn-flat btn-sm"><?php 
                    $query=$this->db->query("SELECT * FROM tbl_mapdua WHERE mapdua_pegawai_id='$kepegawaian_id'");
                    $jml=$query->num_rows();
                    ?>
