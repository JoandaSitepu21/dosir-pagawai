...
<head>
 ...
 <title>E-Dosir Kejati Papua | Map Lima</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dosir
        <small>Map Lima</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Dosir</a></li>
        <li class="active">Map Lima</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Map Lima</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Nip</th>
                  <th>Jabatan</th>
                  <th style="width:150px">Data Map Lima</th>
                </tr>
                </thead>
                <tbody>
                <?php     $no=0;
                ...
                <tr>
                  <td><?php echo $no;?></td>
                   ...
                   <td class="center">
                    ...
                    <a href="<?php echo base_url().'admin/map_lima/viewdatamap_lima/'.$kepegawaian_id;?>" class="btn btn-primary btn-flat btn-sm"><?php 
                    $query=$this->db->query("SELECT * FROM tbl_maplima WHERE maplima_pegawai_id='$kepegawaian_id'");
                    $jml=$query->num_rows();
                    ?>
