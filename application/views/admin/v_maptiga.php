...
<head>
 ...
 <title>E-Dosir Kejati Papua | Map Tiga</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <?php 
    $this->load->view('admin/v_menuutama');
  ?>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dosir
        <small>Map Tiga</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Dosir</a></li>
        <li class="active">Map Tiga</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Map Tiga</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Nip</th>
                  <th>Jabatan</th>
                  <th style="width:150px">Data Map Tiga</th>
                </tr>
                </thead>
                <tbody>
                <?php     $no=0;
                ...
                <tr>
                  <td><?php echo $no;?></td>
                   ...
                   <td class="center">
                    ...
                    <a href="<?php echo base_url().'admin/map_tiga/viewdatamap_tiga/'.$kepegawaian_id;?>" class="btn btn-primary btn-flat btn-sm"><?php 
                    $query=$this->db->query("SELECT * FROM tbl_maptiga WHERE maptiga_pegawai_id='$kepegawaian_id'");
                    $jml=$query->num_rows();
                    ?>
