...
<head>
  ...
  <title>E-Dosir Kejati Papua | Ubah Data Map Dua</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo base_url().'admin/map_dua'?>" class="btn btn-warning btn-flat btn-sm pull-right">Kembali</a>
            </div>
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/map_dua/update_mapdua'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                  <?php 
              $mapdua_pegawai_id=$b['mapdua_pegawai_id'];
                    $inbox=$this->db->query("SELECT * FROM tbl_kepegawaian WHERE kepegawaian_id='$mapdua_pegawai_id' ");
                ...
                <div class="form-group">
                  <label>Nama Berkas Map Dua</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                         <input type="hidden" name="kode" value="<?php echo $b['mapdua_id'];?>">
                       <input type="hidden" name="file" value="<?php echo $b['mapdua_fileberkas'];?>">
                         <input type="text" name="xnamaberkas" class="form-control" value="<?php echo $b['mapdua_namaberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
                  <label>Tanggal Berkas Map Dua</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                         <input type="text" name="xtanggalmaps" class="form-control" value="<?php echo $b['mapdua_tanggalberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
