...
<head>
 ...
 <title>E-Dosir Kejati Papua | Ubah Data Map Lima</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Map Lima
        <small>Ubah Data Map Lima</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url().'admin/dashboard'?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url().'admin/map_lima'?>">Map Lima</a></li>
        <li class="active">Ubah Data Map Lima</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tambah Data Map Lima</h3>
              <a href="<?php echo base_url().'admin/map_lima'?>" class="btn btn-warning btn-flat btn-sm pull-right">Kembali</a>
            </div>
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/map_lima/update_maplima'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                  <?php 
              $maplima_pegawai_id=$b['maplima_pegawai_id'];
                    $inbox=$this->db->query("SELECT * FROM tbl_kepegawaian WHERE kepegawaian_id='$maplima_pegawai_id' ");
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?php endforeach;?>
                <div class="form-group">
                  <label>Nama Berkas Map Lima</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                         <input type="hidden" name="kode" value="<?php echo $b['maplima_id'];?>">
                       <input type="hidden" name="file" value="<?php echo $b['maplima_fileberkas'];?>">
                         <input type="text" name="xnamaberkas" class="form-control" value="<?php echo $b['maplima_namaberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
                  <label>Tanggal Berkas Map Lima</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                         <input type="text" name="xtanggalmaps" class="form-control" value="<?php echo $b['maplima_tanggalberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
                  <label>File Berkas Map Lima</label>
                   <div class="input-group">
