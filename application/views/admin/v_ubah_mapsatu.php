...
<head>
 ...
 <title>E-Dosir Kejati Papua | Ubah Data Map Satu</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Map Dua
        <small>Ubah Data Map Satu</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url().'admin/dashboard'?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url().'admin/map_satu'?>">Map Satu</a></li>
        <li class="active">Ubah Data Map Satu</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo base_url().'admin/map_satu'?>" class="btn btn-warning btn-flat btn-sm pull-right">Kembali</a>
            </div>
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/map_satu/update_mapsatu'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                  <?php 
              $mapsatu_pegawai_id=$b['mapsatu_pegawai_id'];
                    $inbox=$this->db->query("SELECT * FROM tbl_kepegawaian WHERE kepegawaian_id='$mapsatu_pegawai_id' ");
                ...
                <div class="form-group">
                  <label>Nama Lengkap</label>
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                     <input type="hidden" name="x_idpegawai" value="<?php echo $kepegawaian_id;?>">
                  ...
                  <div class="form-group">
                    ...
                    <?php endforeach;?>
                <div class="form-group">
                  <label>Nama Berkas Map Satu</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                         <input type="hidden" name="kode" value="<?php echo $b['mapsatu_id'];?>">
                       <input type="hidden" name="file" value="<?php echo $b['mapsatu_fileberkas'];?>">
                         <input type="text" name="xnamaberkas" class="form-control" value="<?php echo $b['mapsatu_namaberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
                  <label>Tanggal Berkas Map Satu</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                         <input type="text" name="xtanggalmaps" class="form-control" value="<?php echo $b['mapsatu_tanggalberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
                  <label>File Berkas Map Satu</label>
                   <div class="input-group">
