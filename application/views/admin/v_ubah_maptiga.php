...
<head>
 ...
 <title>E-Dosir Kejati Papua | Ubah Data Map Tiga</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Map Tiga
        <small>Ubah Data Map Tiga</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url().'admin/dashboard'?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url().'admin/map_tiga'?>">Map Tiga</a></li>
        <li class="active">Ubah Data Map Tiga</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tambah Data Map Tiga</h3>
              <a href="<?php echo base_url().'admin/map_tiga'?>" class="btn btn-warning btn-flat btn-sm pull-right">Kembali</a>
            </div>
            <!-- /.box-header -->
              <form  action="<?php echo base_url().'admin/map_tiga/update_maptiga'?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                  <?php 
              $maptiga_pegawai_id=$b['maptiga_pegawai_id'];
                    $inbox=$this->db->query("SELECT * FROM tbl_kepegawaian WHERE kepegawaian_id='$maptiga_pegawai_id' ");
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?php endforeach;?>
                <div class="form-group">
                  <label>Nama Berkas Map Tiga</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                         <input type="hidden" name="kode" value="<?php echo $b['maptiga_id'];?>">
                       <input type="hidden" name="file" value="<?php echo $b['maptiga_fileberkas'];?>">
                         <input type="text" name="xnamaberkas" class="form-control" value="<?php echo $b['maptiga_namaberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
                  <label>Tanggal Berkas Map Tiga</label>
                   <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                         <input type="text" name="xtanggalmaps" class="form-control" value="<?php echo $b['maptiga_tanggalberkas'];?>">
                      </div>
                </div>
                <div class="form-group">
                  <label>File Berkas Map Tiga</label>
                   <div class="input-group">
